...
import com.example.tp2.adapter.ProduitAdapter;
import com.example.tp2.beans.Produit;
import com.example.tp2.services.ProduitService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int photo = produit.getPhoto();
                String nom = produit.getNom();
                String description = produit.getDescription();
                String detailsIngred = produit.getDetailsIngred();
                String preparation = produit.getPreparation();
